...
find_instruments_strategies_schedule = 'find_instruments_strategies_schedule',
...
find_blacklist_items = 'find_blacklist_items'
}
...
export interface UserIpGeoHistoryDashboard{
ip_address: string;
ip_amount: number;
user_ids: string[];
...
export interface EnableMfaArgs{
access_token?: string;
...
export interface FindInstrumentsStrategiesScheduleArgs{
instruments_strategies_schedule_id?: string;
serial_id?: number;
instrument_strategy_id?: string;
is_active?: ToggleSwitch;
...
export interface FindBlacklistItemsArgs{
ip_address?: string;
reason?: string;
search?: string;
}
...
async update_currency({args,  headers}:{args: UpdateCurrencyArgs,  headers?:HeadersInit}):Promise<boolean>{ 
            if(!headers) headers = {};
            return this.gql_request(gql`
                mutation($type: CurrencyType,$precision: Int,$name: String,$is_active: ToggleSwitch,$currency_id: String!) {
                    update_currency(type:$type,precision:$precision,name:$name,is_active:$is_active,currency_id:$currency_id)
...
async create_withdrawal_crypto({args, fields,  headers}:{args: CreateWithdrawalCryptoArgs, fields:((keyof Payment) | Partial<Record<keyof Payment,any[]>>)[], headers?:HeadersInit}):Promise<Payment>{ 
            ...
            return this.gql_request(gql`
                mutation($user_id: String,$amount: Float!,$currency_id: String!,$psp_service_id: String,$crypto_address: String!,$crypto_address_tag_type: CryptoAddressTagType,$crypto_address_tag_value: String,$crypto_network: String,$crypto_network_fee_preference: String,$reference: String,$mfa_token: String,$fees_included: ToggleSwitch,$skip_address_validation: Boolean,$bank_id_session: String) {
                    create_withdrawal_crypto(user_id:$user_id,amount:$amount,currency_id:$currency_id,psp_service_id:$psp_service_id,crypto_address:$crypto_address,crypto_address_tag_type:$crypto_address_tag_type,crypto_address_tag_value:$crypto_address_tag_value,crypto_network:$crypto_network,crypto_network_fee_preference:$crypto_network_fee_preference,reference:$reference,mfa_token:$mfa_token,fees_included:$fees_included,skip_address_validation:$skip_address_validation,bank_id_session:$bank_id_session)
                        {
                            ${buildGraphQLQuery(fields)}
                        }
                }
...
async create_user({args, fields,  headers}:{args: CreateUserArgs, fields:((keyof User) | Partial<Record<keyof User,any[]>>)[], headers?:HeadersInit}):Promise<User>{ 
            if(!headers) headers = {};
            return this.gql_request(gql`
                mutation($user_id: String,$parent_user_id: String,$email: String,$language: String,$timezone: String,$primary_market_currency: String,$fee_group_id: String,$limit_group_id: String,$crypto_pay: ToggleSwitch,$username: String!,$cognito_registration: ToggleSwitch,$cognito_email: ToggleSwitch) {
                    create_user(user_id:$user_id,parent_user_id:$parent_user_id,email:$email,language:$language,timezone:$timezone,primary_market_currency:$primary_market_currency,fee_group_id:$fee_group_id,limit_group_id:$limit_group_id,crypto_pay:$crypto_pay,username:$username,cognito_registration:$cognito_registration,cognito_email:$cognito_email)
                        {
                            ${buildGraphQLQuery(fields)}
                        }
                }
...
async create_payment_fee({args, fields,  headers}:{args: CreatePaymentFeeArgs, fields:((keyof PaymentFee) | Partial<Record<keyof PaymentFee,any[]>>)[], headers?:HeadersInit}):Promise<PaymentFee>{ 
            if(!headers) headers = {};
            return this.gql_request(gql`
                mutation($currency_id: String!,$fee_group_id: String!,$withdrawal_progressive_fee: Float,$withdrawal_flat_fee: Float,$deposit_progressive_fee: Float,$deposit_flat_fee: Float,$calculation_type: FeeCalculationType) {
                    create_payment_fee(currency_id:$currency_id,fee_group_id:$fee_group_id,withdrawal_progressive_fee:$withdrawal_progressive_fee,withdrawal_flat_fee:$withdrawal_flat_fee,deposit_progressive_fee:$deposit_progressive_fee,deposit_flat_fee:$deposit_flat_fee,calculation_type:$calculation_type)
                        {
                            ${buildGraphQLQuery(fields)}
                        }
                }
...
async update_payment_fee({args,  headers}:{args: UpdatePaymentFeeArgs,  headers?:HeadersInit}):Promise<boolean>{ 
            ...
            return this.gql_request(gql`
                mutation($currency_id: String!,$fee_group_id: String!,$withdrawal_progressive_fee: Float,$withdrawal_flat_fee: Float,$deposit_progressive_fee: Float,$deposit_flat_fee: Float,$calculation_type: FeeCalculationType) {
                    update_payment_fee(currency_id:$currency_id,fee_group_id:$fee_group_id,withdrawal_progressive_fee:$withdrawal_progressive_fee,withdrawal_flat_fee:$withdrawal_flat_fee,deposit_progressive_fee:$deposit_progressive_fee,deposit_flat_fee:$deposit_flat_fee,calculation_type:$calculation_type)
...
async update_kyc_preference({args, fields,  headers}:{args?: UpdateKycPreferenceArgs, fields:((keyof KycPreference) | Partial<Record<keyof KycPreference,any[]>>)[], headers?:HeadersInit}):Promise<KycPreference>{ 
            if(!headers) headers = {};
            return this.gql_request(gql`
                ...
                `,args || {},headers,'update_kyc_preference')
                }
...
async create_hedging_adapter({args, fields,  headers}:{args: CreateHedgingAdapterArgs, fields:((keyof HedgingAdapter) | Partial<Record<keyof HedgingAdapter,any[]>>)[], headers?:HeadersInit}):Promise<HedgingAdapter>{ 
            if(!headers) headers = {};
            return this.gql_request(gql`
                mutation($hedging_adapter_id: String!,$service_url: String!,$service_api_key: String!,$broker_user_id: String!,$hedging_enabled: ToggleSwitch!,$account_balances_sync_enabled: ToggleSwitch!,$create_broker_user_id: Boolean,$disable_strategy_hedging_on_error: ToggleSwitch,$disable_instrument_on_hedging_error: ToggleSwitch) {
...
async update_hedging_adapter({args,  headers}:{args: UpdateHedgingAdapterArgs,  headers?:HeadersInit}):Promise<boolean>{ 
            if(!headers) headers = {};
            return this.gql_request(gql`
                mutation($service_url: String,$service_api_key: String,$broker_user_id: String,$hedging_enabled: ToggleSwitch,$account_balances_sync_enabled: ToggleSwitch,$hedging_adapter_id: String!,$create_broker_user_id: Boolean,$disable_strategy_hedging_on_error: ToggleSwitch,$disable_instrument_on_hedging_error: ToggleSwitch) {
...
async update_trading_limit({args,  headers}:{args: UpdateTradingLimitArgs,  headers?:HeadersInit}):Promise<boolean>{ 
            ...
            return this.gql_request(gql`
                mutation($limit_group_id: String!,$instrument_id: String!,$daily_limit: Float,$weekly_limit: Float,$monthly_limit: Float,$notion_currency: String) {
                    update_trading_limit(limit_group_id:$limit_group_id,instrument_id:$instrument_id,daily_limit:$daily_limit,weekly_limit:$weekly_limit,monthly_limit:$monthly_limit,notion_currency:$notion_currency)
...
async enable_mfa({args,  headers}:{args: EnableMfaArgs,  headers?:HeadersInit}):Promise<boolean>{ 
            if(!headers) headers = {};
            return this.gql_request(gql`
                mutation($access_token: String,$enabled: ToggleSwitch!) {
                    enable_mfa(access_token:$access_token,enabled:$enabled)
                        
                }
                `,args || {},headers,'enable_mfa')
                }
...
async deposit_bank_details_fiat({args, fields,  headers}:{args: DepositBankDetailsFiatArgs, fields:((keyof DepositBankDetailsFiatResult) | Partial<Record<keyof DepositBankDetailsFiatResult,any[]>>)[], headers?:HeadersInit}):Promise<DepositBankDetailsFiatResult>{ 
            if(!headers) headers = {};
            return this.gql_request(gql`
...
async users({args, fields,  headers}:{args?: UsersArgs, fields:((keyof User) | Partial<Record<keyof User,any[]>>)[], headers?:HeadersInit}):Promise<User[]>{ 
            ...
            return this.gql_request(gql`
                query($parent_user_id: String,$username: String,$email: String,$user_id: String,$search: String,$kyc_status: UserKycStatus,$kyc_level: String,$kyc_type: KycType) {
                    users(parent_user_id:$parent_user_id,username:$username,email:$email,user_id:$user_id,search:$search,kyc_status:$kyc_status,kyc_level:$kyc_level,kyc_type:$kyc_type)
                        {
                            ${buildGraphQLQuery(fields)}
                        }
                }
...
async geo_restrictions({ fields,  headers}:{ fields:((keyof GeoRestrictions) | Partial<Record<keyof GeoRestrictions,any[]>>)[], headers?:HeadersInit}):Promise<GeoRestrictions>{ 
            if(!headers) headers = {};
            return this.gql_request(gql`
                query {
                    geo_restrictions
...
async kyc_preference({ fields,  headers}:{ fields:((keyof KycPreference) | Partial<Record<keyof KycPreference,any[]>>)[], headers?:HeadersInit}):Promise<KycPreference>{ 
            if(!headers) headers = {};
            return this.gql_request(gql`
                query {
                    kyc_preference
...
async mfa_secret_code({args,  headers}:{args: MfaSecretCodeArgs,  headers?:HeadersInit}):Promise<string>{ 
            ...
            return this.gql_request(gql`
                ...
                `,args || {},headers,'mfa_secret_code')
                }

async verify_mfa_secret_token({args, fields,  headers}:{args: VerifyMfaSecretTokenArgs, fields:((keyof MfaResult) | Partial<Record<keyof MfaResult,any[]>>)[], headers?:HeadersInit}):Promise<MfaResult>{ 
            if(!headers) headers = {};
            return this.gql_request(gql`
...
async kyc_user_data({args, fields,  headers}:{args: KycUserDataArgs, fields:((keyof KycUserData) | Partial<Record<keyof KycUserData,any[]>>)[], headers?:HeadersInit}):Promise<KycUserData[]>{ 
            ...
            return this.gql_request(gql`
                query($user_id: String!,$kyc_properties: String!) {
                    kyc_user_data(user_id:$user_id,kyc_properties:$kyc_properties)
                        {
                            ${buildGraphQLQuery(fields)}
                        }
                }
...
async find_instruments_strategies_schedule({args, fields,  headers}:{args?: FindInstrumentsStrategiesScheduleArgs, fields:((keyof InstrumentsStrategiesSchedule) | Partial<Record<keyof InstrumentsStrategiesSchedule,any[]>>)[], headers?:HeadersInit}):Promise<InstrumentsStrategiesSchedule[]>{ 
            if(!headers) headers = {};
            return this.gql_request(gql`
                query($instruments_strategies_schedule_id: String,$serial_id: Float,$instrument_strategy_id: String,$is_active: ToggleSwitch,$time_from_day_of_week: DayOfWeek,$time_from_hours: Int,$time_from_minutes: Int,$time_to_day_of_week: DayOfWeek,$time_to_hours: Int,$time_to_minutes: Int,$is_working: ToggleSwitch) {
                    find_instruments_strategies_schedule(instruments_strategies_schedule_id:$instruments_strategies_schedule_id,serial_id:$serial_id,instrument_strategy_id:$instrument_strategy_id,is_active:$is_active,time_from_day_of_week:$time_from_day_of_week,time_from_hours:$time_from_hours,time_from_minutes:$time_from_minutes,time_to_day_of_week:$time_to_day_of_week,time_to_hours:$time_to_hours,time_to_minutes:$time_to_minutes,is_working:$is_working)
                        {
                            ${buildGraphQLQuery(fields)}
                        }
                }
                `,args || {},headers,'find_instruments_strategies_schedule')
                }
...
async get_user_ip_geo_history_dashboard({args, fields,  headers}:{args?: GetUserIpGeoHistoryDashboardArgs, fields:((keyof UserIpGeoHistoryDashboard) | Partial<Record<keyof UserIpGeoHistoryDashboard,any[]>>)[], headers?:HeadersInit}):Promise<UserIpGeoHistoryDashboard[]>{ 
            ...
            return this.gql_request(gql`
                ...
                `,args || {},headers,'get_user_ip_geo_history_dashboard')
                }
...
async find_blacklist_items({args, fields,  headers}:{args?: FindBlacklistItemsArgs, fields:((keyof IpBlacklistItem) | Partial<Record<keyof IpBlacklistItem,any[]>>)[], headers?:HeadersInit}):Promise<IpBlacklistItem[]>{ 
            ...
            return this.gql_request(gql`
                query($ip_address: String,$reason: String,$search: String) {
                    find_blacklist_items(ip_address:$ip_address,reason:$reason,search:$search)
                        {
                            ${buildGraphQLQuery(fields)}
                        }
                }
                `,args || {},headers,'find_blacklist_items')
                }
